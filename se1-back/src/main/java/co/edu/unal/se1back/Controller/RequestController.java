...
public class RequestController {
    ...
    @GetMapping("/requestByReceiverID/{receiver}")
    public List<Request> getRequestByReceiverId(@PathVariable (value = "receiver") Long id)throws SQLException, ResourceNotFoundException {
